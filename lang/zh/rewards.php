...
return [
    ...
    'itinerary' => '保存行程', 'itinerary_desc' => '保存完成的旅行计划以获得绿色积分。', 'plan_route' => '规划并保存行程',
    'save_destination' => '收藏目的地', 'save_desc' => '建立您想要游览的地点清单。', 'explore' => '探索地点',
    'complete_profile' => '完善个人资料', 'profile_desc' => '分享旅行兴趣以获得更合适的推荐。', 'view_profile' => '查看资料',
    'share_trip' => '分享行程', 'share_trip_desc' => '与旅伴分享您已保存的行程。', 'view_trips' => '查看您的行程',
    'collection' => '您的奖励', 'badges' => '活动奖励', 'activities' => '通过您的操作获得', 'collect' => '领取',
    ...
    'activity_names' => ['daily_login' => '每日登录', 'save_attraction' => '收藏景点', 'save_itinerary' => '保存行程', 'export_itinerary' => '导出行程 PDF', 'export_guidance' => '导出分步指南', 'share_itinerary' => '分享行程', 'tree_milestone' => '成就／树木里程碑'],
    'activity_frequency' => ['daily_login' => '每天一次', 'save_attraction' => '每次成功收藏', 'save_itinerary' => '每次成功保存行程', 'export_itinerary' => '每次成功导出', 'export_guidance' => '每次成功导出', 'share_itinerary' => '每次成功分享', 'tree_milestone' => '每达到 5 个树木等级'],
    'activity_points' => ['tree_milestone' => '+50 至 +150'],
    'transaction_activities' => ['daily_login' => '每日登录', 'save_attraction' => '收藏景点', 'save_itinerary' => '保存行程', 'generate_itinerary' => '生成行程（旧记录）', 'export_itinerary' => '导出行程', 'export_guidance' => '导出指南', 'share_itinerary' => '分享行程', 'purchase' => '购买', 'fertilize' => '为树施肥', 'fertilizer_purchase' => '购买肥料', 'tree_milestone' => '树木里程碑'],
