<footer class="custom-footer">
    <div class="container footer-grid">
        ...
        <div class="footer-column"><h2>{{ __('ui.footer.discover') }}</h2><a href="{{ route('about-malaysia') }}">{{ __('ui.footer.about') }}</a><a href="{{ route('travel-preferences.edit') }}">{{ __('ui.footer.preferences') }}</a><a href="{{ route('profile') }}">{{ __('ui.footer.profile') }}</a></div>
