...
<form class="admin-form" method="POST" enctype="multipart/form-data" action="{{ $attraction->exists ? route('admin.attractions.update',$attraction) : route('admin.attractions.store') }}" data-ajax-crud>@csrf @if($attraction->exists)@method('PUT')@endif
